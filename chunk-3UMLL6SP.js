...
`],encapsulation:2})}return n})(),Pt=class{overlayRef;config;componentInstance=null;componentRef=null;containerInstance;disableClose;closed=new _;backdropClick;keydownEvents;outsidePointerEvents;id;_detachSubscription;constructor(o,e){this.overlayRef=o,this.config=e,this.disableClose=e.disableClose,this.backdropClick=o.backdropClick(),this.keydownEvents=o.keydownEvents(),this.outsidePointerEvents=o.outsidePointerEvents(),this.id=e.id,this.keydownEvents.subscribe(t=>{t.keyCode===27&&!this.disableClose&&!ie(t)&&(t.preventDefault(),this.close(void 0,{focusOrigin:"keyboard"}))}),this.backdropClick.subscribe(()=>{!this.disableClose&&this._canClose()?this.close(void 0,{focusOrigin:"mouse"}):this.containerInstance._recaptureFocus?.()}),this._detachSubscription=o.detachments().subscribe(()=>{e.closeOnOverlayDetachments!==!1&&this.close()})}close(o,e){if(this._canClose(o)){let t=this.closed;this.containerInstance._closeInteractionType=e?.focusOrigin||"program",this._detachSubscription.unsubscribe(),this.overlayRef.dispose(),t.next(o),t.complete(),this.componentInstance=this.containerInstance=null}}updatePosition(){return this.overlayRef.updatePosition(),this}updateSize(o="",e=""){return this.overlayRef.updateSize({width:o,height:e}),this}addPanelClass(o){return this.overlayRef.addPanelClass(o),this}removePanelClass(o){return this.overlayRef.removePanelClass(o),this}_canClose(o){let e=this.config;return!!this.containerInstance&&(!e.closePredicate||e.closePredicate(o,e,this.componentInstance))}},Fa=new g("DialogScrollStrategy",{providedIn:"root",factory:()=>{let n=s(T);return()=>ut(n)}}),La=new g("DialogData"),Ba=new g("DefaultDialogConfig");function Na(n){let o=Q(n),e=new H;return{valueSignal:o,get value(){return o()},change:e,ngOnDestroy(){e.complete()}}}var Gi=(()=>{class n{_injector=s(T);_defaultOptions=s(Ba,{optional:!0});_parentDialog=s(n,{optional:!0,skipSelf:!0});_overlayContainer=s(si);_idGenerator=s(Y);_openDialogsAtThisLevel=[];_afterAllClosedAtThisLevel=new _;_afterOpenedAtThisLevel=new _;_ariaHiddenElements=new Map;_scrollStrategy=s(Fa);get openDialogs(){return this._parentDialog?this._parentDialog.openDialogs:this._openDialogsAtThisLevel}get afterOpened(){return this._parentDialog?this._parentDialog.afterOpened:this._afterOpenedAtThisLevel}afterAllClosed=tt(()=>this.openDialogs.length?this._getAfterAllClosed():this._getAfterAllClosed().pipe(we(void 0)));constructor(){}open(e,t){let i=this._defaultOptions||new He;t=O(O({},i),t),t.id=t.id||this._idGenerator.getId("cdk-dialog-"),t.id&&this.getDialogById(t.id);let a=this._getOverlayConfig(t),r=Pe(this._injector,a),l=new Pt(r,t),h=this._attachContainer(r,l,t);if(l.containerInstance=h,!this.openDialogs.length){let u=this._overlayContainer.getContainerElement();h._focusTrapped?h._focusTrapped.pipe(Ie(1)).subscribe(()=>{this._hideNonDialogContentFromAssistiveTechnology(u)}):this._hideNonDialogContentFromAssistiveTechnology(u)}return this._attachDialogContent(e,l,h,t),this.openDialogs.push(l),l.closed.subscribe(()=>this._removeOpenDialog(l,!0)),this.afterOpened.next(l),l}closeAll(){Yi(this.openDialogs,e=>e.close())}getDialogById(e){return this.openDialogs.find(t=>t.id===e)}ngOnDestroy(){Yi(this._openDialogsAtThisLevel,e=>{e.config.closeOnDestroy===!1&&this._removeOpenDialog(e,!1)}),Yi(this._openDialogsAtThisLevel,e=>e.close()),this._afterAllClosedAtThisLevel.complete(),this._afterOpenedAtThisLevel.complete(),this._openDialogsAtThisLevel=[]}_getOverlayConfig(e){let t=new Ee({positionStrategy:e.positionStrategy||je().centerHorizontally().centerVertically(),scrollStrategy:e.scrollStrategy||this._scrollStrategy(),panelClass:e.panelClass,hasBackdrop:e.hasBackdrop,direction:e.direction,minWidth:e.minWidth,minHeight:e.minHeight,maxWidth:e.maxWidth,maxHeight:e.maxHeight,width:e.width,height:e.height,disposeOnNavigation:e.closeOnNavigation,disableAnimations:e.disableAnimations});return e.backdropClass&&(t.backdropClass=e.backdropClass),t}_attachContainer(e,t,i){let a=i.injector||i.viewContainerRef?.injector,r=[{provide:He,useValue:i},{provide:Pt,useValue:t},{provide:ft,useValue:e}],l;i.container?typeof i.container=="function"?l=i.container:(l=i.container.type,r.push(...i.container.providers(i))):l=Xi;let h=new fe(l,i.viewContainerRef,T.create({parent:a||this._injector,providers:r}));return e.attach(h).instance}_attachDialogContent(e,t,i,a){if(e instanceof We){let r=this._createInjector(a,t,i,void 0),l={$implicit:a.data,dialogRef:t};a.templateContext&&(l=O(O({},l),typeof a.templateContext=="function"?a.templateContext():a.templateContext)),i.attachTemplatePortal(new De(e,null,l,r))}else{let r=this._createInjector(a,t,i,this._injector),l=i.attachComponentPortal(new fe(e,a.viewContainerRef,r));t.componentRef=l,t.componentInstance=l.instance}}_createInjector(e,t,i,a){let r=e.injector||e.viewContainerRef?.injector,l=[{provide:La,useValue:e.data},{provide:Pt,useValue:t}];return e.providers&&(typeof e.providers=="function"?l.push(...e.providers(t,e,i)):l.push(...e.providers)),e.direction&&(!r||!r.get(me,null,{optional:!0}))&&l.push({provide:me,useValue:Na(e.direction)}),T.create({parent:r||a,providers:l})}_removeOpenDialog(e,t){let i=this.openDialogs.indexOf(e);i>-1&&(this.openDialogs.splice(i,1),this.openDialogs.length||(this._ariaHiddenElements.forEach((a,r)=>{a?r.setAttribute("aria-hidden",a):r.removeAttribute("aria-hidden")}),this._ariaHiddenElements.clear(),t&&this._getAfterAllClosed().next()))}_hideNonDialogContentFromAssistiveTechnology(e){if(e.parentElement){let t=e.parentElement.children;for(let i=t.length-1;i>-1;i--){let a=t[i];a!==e&&a.nodeName!=="SCRIPT"&&a.nodeName!=="STYLE"&&!a.hasAttribute("aria-live")&&!a.hasAttribute("popover")&&(this._ariaHiddenElements.set(a,a.getAttribute("aria-hidden")),a.setAttribute("aria-hidden","true"))}}}_getAfterAllClosed(){let e=this._parentDialog;return e?e._getAfterAllClosed():this._afterAllClosedAtThisLevel}static \u0275fac=function(t){return new(t||n)};static \u0275prov=I({token:n,factory:n.\u0275fac,providedIn:"root"})}return n})();function Yi(n,o){let e=n.length;for(;e--;)o(n[e])}var Eo=(()=>{class n{static \u0275fac=function(t){return new(t||n)};static \u0275mod=A({type:n});static \u0275inj=R({providers:[Gi],imports:[pe,Oe,qt,Oe]})}return n})();function Va(n,o){}var ci=class{viewContainerRef;injector;id;role="dialog";panelClass="";hasBackdrop=!0;backdropClass="";disableClose=!1;closePredicate;width="";height="";minWidth;minHeight;maxWidth;maxHeight;position;data=null;direction;ariaDescribedBy=null;ariaLabelledBy=null;ariaLabel=null;ariaModal=!1;autoFocus="first-tabbable";restoreFocus=!0;delayFocusTrap=!0;scrollStrategy;closeOnNavigation=!0;enterAnimationDuration;exitAnimationDuration},qi="mdc-dialog--open",Po="mdc-dialog--opening",To="mdc-dialog--closing",za=150,ja=75,Ha=(()=>{class n extends Xi{_animationStateChanged=new H;_animationsEnabled=!ae();_actionSectionCount=0;_hostElement=this._elementRef.nativeElement;_enterAnimationDuration=this._animationsEnabled?Ao(this._config.enterAnimationDuration)??za:0;_exitAnimationDuration=this._animationsEnabled?Ao(this._config.exitAnimationDuration)??ja:0;_animationTimer=null;_contentAttached(){super._contentAttached(),this._startOpenAnimation()}_startOpenAnimation(){this._animationStateChanged.emit({state:"opening",totalTime:this._enterAnimationDuration}),this._animationsEnabled?(this._hostElement.style.setProperty(Ro,`${this._enterAnimationDuration}ms`),this._requestAnimationFrame(()=>this._hostElement.classList.add(Po,qi)),this._waitForAnimationToComplete(this._enterAnimationDuration,this._finishDialogOpen)):(this._hostElement.classList.add(qi),Promise.resolve().then(()=>this._finishDialogOpen()))}_startExitAnimation(){this._animationStateChanged.emit({state:"closing",totalTime:this._exitAnimationDuration}),this._hostElement.classList.remove(qi),this._animationsEnabled?(this._hostElement.style.setProperty(Ro,`${this._exitAnimationDuration}ms`),this._requestAnimationFrame(()=>this._hostElement.classList.add(To)),this._waitForAnimationToComplete(this._exitAnimationDuration,this._finishDialogClose)):Promise.resolve().then(()=>this._finishDialogClose())}_updateActionSectionCount(e){this._actionSectionCount+=e,this._changeDetectorRef.markForCheck()}_finishDialogOpen=()=>{this._clearAnimationClasses(),this._openAnimationDone(this._enterAnimationDuration)};_finishDialogClose=()=>{this._clearAnimationClasses(),this._animationStateChanged.emit({state:"closed",totalTime:this._exitAnimationDuration})};_clearAnimationClasses(){this._hostElement.classList.remove(Po,To)}_waitForAnimationToComplete(e,t){this._animationTimer!==null&&clearTimeout(this._animationTimer),this._animationTimer=setTimeout(t,e)}_requestAnimationFrame(e){this._ngZone.runOutsideAngular(()=>{typeof requestAnimationFrame=="function"?requestAnimationFrame(e):e()})}_captureInitialFocus(){this._config.delayFocusTrap||this._trapFocus()}_openAnimationDone(e){this._config.delayFocusTrap&&this._trapFocus(),this._animationStateChanged.next({state:"opened",totalTime:e})}ngOnDestroy(){super.ngOnDestroy(),this._animationTimer!==null&&clearTimeout(this._animationTimer)}attachComponentPortal(e){let t=super.attachComponentPortal(e);return t.location.nativeElement.classList.add("mat-mdc-dialog-component-host"),t}static \u0275fac=(()=>{let e;return function(i){return(e||(e=Ue(n)))(i||n)}})();static \u0275cmp=C({type:n,selectors:[["mat-dialog-container"]],hostAttrs:["tabindex","-1",1,"mat-mdc-dialog-container","mdc-dialog"],hostVars:10,hostBindings:function(t,i){t&2&&(be("id",i._config.id),L("aria-modal",i._config.ariaModal)("role",i._config.role)("aria-labelledby",i._config.ariaLabel?null:i._ariaLabelledByQueue[0])("aria-label",i._config.ariaLabel)("aria-describedby",i._config.ariaDescribedBy||null),P("_mat-animation-noopable",!i._animationsEnabled)("mat-mdc-dialog-container-with-actions",i._actionSectionCount>0))},features:[ge],decls:3,vars:0,consts:[[1,"mat-mdc-dialog-inner-container","mdc-dialog__container"],[1,"mat-mdc-dialog-surface","mdc-dialog__surface"],["cdkPortalOutlet",""]],template:function(t,i){t&1&&(d(0,"div",0)(1,"div",1),te(2,Va,0,0,"ng-template",2),c()())},dependencies:[ze],styles:[`.mat-mdc-dialog-container {
  width: 100%;
  height: 100%;
  display: block;
  box-sizing: border-box;
...
`],encapsulation:2,changeDetection:0})}return n})();var $o=(()=>{class n{static \u0275fac=function(t){return new(t||n)};static \u0275mod=A({type:n});static \u0275inj=R({imports:[qt,pe,U,kt]})}return n})();var _i=class n{user=wt.required();editClicked=Ct();deleteClicked=Ct();static \u0275fac=function(e){return new(e||n)};static \u0275cmp=C({type:n,selectors:[["app-user-card"]],inputs:{user:[1,"user"]},outputs:{editClicked:"editClicked",deleteClicked:"deleteClicked"},decls:19,vars:3,consts:[["appearance","outlined",1,"user-card"],[1,"user-card__content"],[1,"user-card__avatar"],[1,"user-card__info"],[1,"user-card__name"],[1,"user-card__email"],[1,"user-card__cpf"],[1,"user-card__actions"],["mat-icon-button","","matTooltip","Editar","aria-label","Editar usu\xE1rio",3,"click"],["mat-icon-button","","matTooltip","Excluir","aria-label","Excluir usu\xE1rio",1,"delete-btn",3,"click"]],template:function(e,t){e&1&&(d(0,"mat-card",0)(1,"mat-card-content",1)(2,"div",2)(3,"mat-icon"),f(4,"person"),c()(),d(5,"div",3)(6,"span",4),f(7),c(),d(8,"span",5),f(9),c()(),d(10,"span",6),f(11),c(),d(12,"div",7)(13,"button",8),y("click",function(){return t.editClicked.emit(t.user())}),d(14,"mat-icon"),f(15,"edit"),c()(),d(16,"button",9),y("click",function(){return t.deleteClicked.emit(t.user().id)}),d(17,"mat-icon"),f(18,"delete"),c()()()()()),e&2&&(m(7),G(t.user().nome),m(2),G(t.user().email),m(2),G(t.user().cpf))},dependencies:[Xo,Wo,Yo,ye,Be,xe,$t,$o,Ki],styles:[".user-card[_ngcontent-%COMP%]{transition:all .2s ease;border-radius:8px}.user-card[_ngcontent-%COMP%]:hover{box-shadow:0 8px 16px #00000026;transform:translateY(-2px)}.user-card[_ngcontent-%COMP%]:focus-within{outline:2px solid var(--mat-sys-primary);outline-offset:2px}.user-card__content[_ngcontent-%COMP%]{display:flex;align-items:center;gap:16px;padding:12px 16px}.user-card__avatar[_ngcontent-%COMP%]{width:40px;height:40px;min-width:40px;border-radius:50%;background-color:var(--mat-sys-primary-container);color:var(--mat-sys-on-primary-container);display:flex;align-items:center;justify-content:center;flex-shrink:0;font-weight:500;transition:all .2s ease;box-shadow:0 2px 4px #0000001a}.user-card[_ngcontent-%COMP%]:hover   .user-card__avatar[_ngcontent-%COMP%]{box-shadow:0 4px 8px #0000001f;transform:scale(1.08)}.user-card__info[_ngcontent-%COMP%]{flex:1;min-width:0;display:flex;flex-direction:column}.user-card__name[_ngcontent-%COMP%]{font:var(--mat-sys-body-large);color:var(--mat-sys-on-surface);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;font-weight:500;transition:color .2s ease}.user-card[_ngcontent-%COMP%]:hover   .user-card__name[_ngcontent-%COMP%]{color:var(--mat-sys-primary)}.user-card__email[_ngcontent-%COMP%]{font:var(--mat-sys-body-small);color:var(--mat-sys-on-surface-variant);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;margin-top:2px;transition:color .2s ease}.user-card[_ngcontent-%COMP%]:hover   .user-card__email[_ngcontent-%COMP%]{color:var(--mat-sys-on-surface)}.user-card__cpf[_ngcontent-%COMP%]{font:var(--mat-sys-body-small);color:var(--mat-sys-on-surface-variant);flex-shrink:0;display:none}@media(min-width:640px){.user-card__cpf[_ngcontent-%COMP%]{display:block}}.user-card__actions[_ngcontent-%COMP%]{flex-shrink:0;display:flex;gap:4px;opacity:.7;transition:opacity .2s ease}.user-card[_ngcontent-%COMP%]:hover   .user-card__actions[_ngcontent-%COMP%]{opacity:1}.user-card__actions[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]{transition:all .2s ease}.user-card__actions[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]:hover{transform:scale(1.1)}.user-card__actions[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]:active{transform:scale(.95)}.delete-btn[_ngcontent-%COMP%]{color:var(--mat-sys-error)}.delete-btn[_ngcontent-%COMP%]:hover{color:#c62828}"],changeDetection:0})};var tn=class{_box;_destroyed=new _;_resizeSubject=new _;_resizeObserver;_elementObservables=new Map;constructor(o){this._box=o,typeof ResizeObserver<"u"&&(this._resizeObserver=new ResizeObserver(e=>this._resizeSubject.next(e)))}observe(o){return this._elementObservables.has(o)||this._elementObservables.set(o,new fn(e=>{let t=this._resizeSubject.subscribe(e);return this._resizeObserver?.observe(o,{box:this._box}),()=>{this._resizeObserver?.unobserve(o),t.unsubscribe(),this._elementObservables.delete(o)}}).pipe(ee(e=>e.some(t=>t.target===o)),yn({bufferSize:1,refCount:!0}),j(this._destroyed))),this._elementObservables.get(o)}destroy(){this._destroyed.next(),this._destroyed.complete(),this._resizeSubject.complete(),this._elementObservables.clear()}},Zo=(()=>{class n{_cleanupErrorListener;_observers=new Map;_ngZone=s(F);constructor(){typeof ResizeObserver<"u"}ngOnDestroy(){for(let[,e]of this._observers)e.destroy();this._observers.clear(),this._cleanupErrorListener?.()}observe(e,t){let i=t?.box||"content-box";return this._observers.has(i)||this._observers.set(i,new tn(i)),this._observers.get(i).observe(e)}static \u0275fac=function(t){return new(t||n)};static \u0275prov=I({token:n,factory:n.\u0275fac,providedIn:"root"})}return n})();var vr=["notch"],br=["matFormFieldNotchedOutline",""],yr=["*"],Qo=["iconPrefixContainer"],Ko=["textPrefixContainer"],Jo=["iconSuffixContainer"],ea=["textSuffixContainer"],xr=["textField"],Cr=["*",[["mat-label"]],[["","matPrefix",""],["","matIconPrefix",""]],[["","matTextPrefix",""]],[["","matTextSuffix",""]],[["","matSuffix",""],["","matIconSuffix",""]],[["mat-error"],["","matError",""]],[["mat-hint",3,"align","end"]],[["mat-hint","align","end"]]],wr=["*","mat-label","[matPrefix], [matIconPrefix]","[matTextPrefix]","[matTextSuffix]","[matSuffix], [matIconSuffix]","mat-error, [matError]","mat-hint:not([align='end'])","mat-hint[align='end']"];function Mr(n,o){n&1&&N(0,"span",21)}function kr(n,o){if(n&1&&(d(0,"label",20),W(1,1),v(2,Mr,1,0,"span",21),c()),n&2){let e=x(2);E("floating",e._shouldLabelFloat())("monitorResize",e._hasOutline())("id",e._labelId),L("for",e._control.disableAutomaticLabeling?null:e._control.id),m(2),b(!e.hideRequiredMarker&&e._control.required?2:-1)}}function Sr(n,o){if(n&1&&v(0,kr,3,5,"label",20),n&2){let e=x();b(e._hasFloatingLabel()?0:-1)}}function Dr(n,o){n&1&&N(0,"div",7)}function Or(n,o){}function Er(n,o){if(n&1&&te(0,Or,0,0,"ng-template",13),n&2){x(2);let e=Xe(1);E("ngTemplateOutlet",e)}}function Pr(n,o){if(n&1&&(d(0,"div",9),v(1,Er,1,1,null,13),c()),n&2){let e=x();E("matFormFieldNotchedOutlineOpen",e._shouldLabelFloat()),m(),b(e._forceDisplayInfixLabel()?-1:1)}}function Tr(n,o){n&1&&(d(0,"div",10,2),W(2,2),c())}function Rr(n,o){n&1&&(d(0,"div",11,3),W(2,3),c())}function Ar(n,o){}function Ir(n,o){if(n&1&&te(0,Ar,0,0,"ng-template",13),n&2){x();let e=Xe(1);E("ngTemplateOutlet",e)}}function Fr(n,o){n&1&&(d(0,"div",14,4),W(2,4),c())}function Lr(n,o){n&1&&(d(0,"div",15,5),W(2,5),c())}function Br(n,o){n&1&&N(0,"div",16)}function Nr(n,o){n&1&&(d(0,"div",18),W(1,6),c())}function Vr(n,o){if(n&1&&(d(0,"mat-hint",22),f(1),c()),n&2){let e=x(2);E("id",e._hintLabelId),m(),G(e.hintLabel)}}function zr(n,o){if(n&1&&(d(0,"div",19),v(1,Vr,2,2,"mat-hint",22),W(2,7),N(3,"div",23),W(4,8),c()),n&2){let e=x();m(),b(e.hintLabel?1:-1)}}var et=(()=>{class n{static \u0275fac=function(t){return new(t||n)};static \u0275dir=D({type:n,selectors:[["mat-label"]]})}return n})(),sa=new g("MatError"),on=(()=>{class n{id=s(Y).getId("mat-mdc-error-");constructor(){}static \u0275fac=function(t){return new(t||n)};static \u0275dir=D({type:n,selectors:[["mat-error"],["","matError",""]],hostAttrs:[1,"mat-mdc-form-field-error","mat-mdc-form-field-bottom-align"],hostVars:1,hostBindings:function(t,i){t&2&&be("id",i.id)},inputs:{id:"id"},features:[de([{provide:sa,useExisting:n}])]})}return n})(),nn=(()=>{class n{align="start";id=s(Y).getId("mat-mdc-hint-");static \u0275fac=function(t){return new(t||n)};static \u0275dir=D({type:n,selectors:[["mat-hint"]],hostAttrs:[1,"mat-mdc-form-field-hint","mat-mdc-form-field-bottom-align"],hostVars:4,hostBindings:function(t,i){t&2&&(be("id",i.id),L("align",null),P("mat-mdc-form-field-hint-end",i.align==="end"))},inputs:{align:"align",id:"id"}})}return n})(),la=new g("MatPrefix"),an=(()=>{class n{set _isTextSelector(e){this._isText=!0}_isText=!1;static \u0275fac=function(t){return new(t||n)};static \u0275dir=D({type:n,selectors:[["","matPrefix",""],["","matIconPrefix",""],["","matTextPrefix",""]],inputs:{_isTextSelector:[0,"matTextPrefix","_isTextSelector"]},features:[de([{provide:la,useExisting:n}])]})}return n})(),da=new g("MatSuffix"),rn=(()=>{class n{set _isTextSelector(e){this._isText=!0}_isText=!1;static \u0275fac=function(t){return new(t||n)};static \u0275dir=D({type:n,selectors:[["","matSuffix",""],["","matIconSuffix",""],["","matTextSuffix",""]],inputs:{_isTextSelector:[0,"matTextSuffix","_isTextSelector"]},features:[de([{provide:da,useExisting:n}])]})}return n})(),ca=new g("FloatingLabelParent"),ta=(()=>{class n{_elementRef=s(S);get floating(){return this._floating}set floating(e){this._floating=e,this.monitorResize&&this._handleResize()}_floating=!1;get monitorResize(){return this._monitorResize}set monitorResize(e){this._monitorResize=e,this._monitorResize?this._subscribeToResize():this._resizeSubscription.unsubscribe()}_monitorResize=!1;_resizeObserver=s(Zo);_ngZone=s(F);_parent=s(ca);_resizeSubscription=new Ce;constructor(){}ngOnDestroy(){this._resizeSubscription.unsubscribe()}getWidth(){return jr(this._elementRef.nativeElement)}get element(){return this._elementRef.nativeElement}_handleResize(){setTimeout(()=>this._parent._handleLabelResized())}_subscribeToResize(){this._resizeSubscription.unsubscribe(),this._ngZone.runOutsideAngular(()=>{this._resizeSubscription=this._resizeObserver.observe(this._elementRef.nativeElement,{box:"border-box"}).subscribe(()=>this._handleResize())})}static \u0275fac=function(t){return new(t||n)};static \u0275dir=D({type:n,selectors:[["label","matFormFieldFloatingLabel",""]],hostAttrs:[1,"mdc-floating-label","mat-mdc-floating-label"],hostVars:2,hostBindings:function(t,i){t&2&&P("mdc-floating-label--float-above",i.floating)},inputs:{floating:"floating",monitorResize:"monitorResize"}})}return n})();function jr(n){let o=n;if(o.offsetParent!==null)return o.scrollWidth;let e=o.cloneNode(!0);e.style.setProperty("position","absolute"),e.style.setProperty("transform","translate(-9999px, -9999px)"),document.documentElement.appendChild(e);let t=e.scrollWidth;return e.remove(),t}var ia="mdc-line-ripple--active",vi="mdc-line-ripple--deactivating",na=(()=>{class n{_elementRef=s(S);_cleanupTransitionEnd;constructor(){let e=s(F),t=s(ne);e.runOutsideAngular(()=>{this._cleanupTransitionEnd=t.listen(this._elementRef.nativeElement,"transitionend",this._handleTransitionEnd)})}activate(){let e=this._elementRef.nativeElement.classList;e.remove(vi),e.add(ia)}deactivate(){this._elementRef.nativeElement.classList.add(vi)}_handleTransitionEnd=e=>{let t=this._elementRef.nativeElement.classList,i=t.contains(vi);e.propertyName==="opacity"&&i&&t.remove(ia,vi)};ngOnDestroy(){this._cleanupTransitionEnd()}static \u0275fac=function(t){return new(t||n)};static \u0275dir=D({type:n,selectors:[["div","matFormFieldLineRipple",""]],hostAttrs:[1,"mdc-line-ripple"]})}return n})(),oa=(()=>{class n{_elementRef=s(S);_ngZone=s(F);open=!1;_notch;ngAfterViewInit(){let e=this._elementRef.nativeElement,t=e.querySelector(".mdc-floating-label");t?(e.classList.add("mdc-notched-outline--upgraded"),typeof requestAnimationFrame=="function"&&(t.style.transitionDuration="0s",this._ngZone.runOutsideAngular(()=>{requestAnimationFrame(()=>t.style.transitionDuration="")}))):e.classList.add("mdc-notched-outline--no-label")}_setNotchWidth(e){let t=this._notch.nativeElement;!this.open||!e?t.style.width="":t.style.width=`calc(${e}px * var(--mat-mdc-form-field-floating-label-scale, 0.75) + 9px)`}_setMaxWidth(e){this._notch.nativeElement.style.setProperty("--mat-form-field-notch-max-width",`calc(100% - ${e}px)`)}static \u0275fac=function(t){return new(t||n)};static \u0275cmp=C({type:n,selectors:[["div","matFormFieldNotchedOutline",""]],viewQuery:function(t,i){if(t&1&&K(vr,5),t&2){let a;w(a=M())&&(i._notch=a.first)}},hostAttrs:[1,"mdc-notched-outline"],hostVars:2,hostBindings:function(t,i){t&2&&P("mdc-notched-outline--notched",i.open)},inputs:{open:[0,"matFormFieldNotchedOutlineOpen","open"]},attrs:br,ngContentSelectors:yr,decls:5,vars:0,consts:[["notch",""],[1,"mat-mdc-notch-piece","mdc-notched-outline__leading"],[1,"mat-mdc-notch-piece","mdc-notched-outline__notch"],[1,"mat-mdc-notch-piece","mdc-notched-outline__trailing"]],template:function(t,i){t&1&&(Me(),Ri(0,"div",1),Ye(1,"div",2,0),W(3),rt(),Ri(4,"div",3))},encapsulation:2,changeDetection:0})}return n})(),It=(()=>{class n{value=null;stateChanges;id;placeholder;ngControl=null;focused=!1;empty=!1;shouldLabelFloat=!1;required=!1;disabled=!1;errorState=!1;controlType;autofilled;userAriaDescribedBy;disableAutomaticLabeling;describedByIds;static \u0275fac=function(t){return new(t||n)};static \u0275dir=D({type:n})}return n})();var Ft=new g("MatFormField"),Hr=new g("MAT_FORM_FIELD_DEFAULT_OPTIONS"),aa="fill",Ur="auto",ra="fixed",Wr="translateY(-50%)",gt=(()=>{class n{_elementRef=s(S);_changeDetectorRef=s(ce);_platform=s(q);_idGenerator=s(Y);_ngZone=s(F);_defaults=s(Hr,{optional:!0});_currentDirection;_textField;_iconPrefixContainer;_textPrefixContainer;_iconSuffixContainer;_textSuffixContainer;_floatingLabel;_notchedOutline;_lineRipple;_iconPrefixContainerSignal=Mt("iconPrefixContainer");_textPrefixContainerSignal=Mt("textPrefixContainer");_iconSuffixContainerSignal=Mt("iconSuffixContainer");_textSuffixContainerSignal=Mt("textSuffixContainer");_prefixSuffixContainers=lt(()=>[this._iconPrefixContainerSignal(),this._textPrefixContainerSignal(),this._iconSuffixContainerSignal(),this._textSuffixContainerSignal()].map(e=>e?.nativeElement).filter(e=>e!==void 0));_formFieldControl;_prefixChildren;_suffixChildren;_errorChildren;_hintChildren;_labelChild=An(et);get hideRequiredMarker(){return this._hideRequiredMarker}set hideRequiredMarker(e){this._hideRequiredMarker=ke(e)}_hideRequiredMarker=!1;color="primary";get floatLabel(){return this._floatLabel||this._defaults?.floatLabel||Ur}set floatLabel(e){e!==this._floatLabel&&(this._floatLabel=e,this._changeDetectorRef.markForCheck())}_floatLabel;get appearance(){return this._appearanceSignal()}set appearance(e){let t=e||this._defaults?.appearance||aa;this._appearanceSignal.set(t)}_appearanceSignal=Q(aa);get subscriptSizing(){return this._subscriptSizing||this._defaults?.subscriptSizing||ra}set subscriptSizing(e){this._subscriptSizing=e||this._defaults?.subscriptSizing||ra}_subscriptSizing=null;get hintLabel(){return this._hintLabel}set hintLabel(e){this._hintLabel=e,this._processHints()}_hintLabel="";_hasIconPrefix=!1;_hasTextPrefix=!1;_hasIconSuffix=!1;_hasTextSuffix=!1;_labelId=this._idGenerator.getId("mat-mdc-form-field-label-");_hintLabelId=this._idGenerator.getId("mat-mdc-hint-");_describedByIds;get _control(){return this._explicitFormFieldControl||this._formFieldControl}set _control(e){this._explicitFormFieldControl=e}_destroyed=new _;_isFocused=null;_explicitFormFieldControl;_previousControl=null;_previousControlValidatorFn=null;_stateChanges;_valueChanges;_describedByChanges;_outlineLabelOffsetResizeObserver=null;_animationsDisabled=ae();constructor(){let e=this._defaults,t=s(me);e&&(e.appearance&&(this.appearance=e.appearance),this._hideRequiredMarker=!!e?.hideRequiredMarker,e.color&&(this.color=e.color)),Nt(()=>this._currentDirection=t.valueSignal()),this._syncOutlineLabelOffset()}ngAfterViewInit(){this._updateFocusState(),this._animationsDisabled||this._ngZone.runOutsideAngular(()=>{setTimeout(()=>{this._elementRef.nativeElement.classList.add("mat-form-field-animations-enabled")},300)}),this._changeDetectorRef.detectChanges()}ngAfterContentInit(){this._assertFormFieldControl(),this._initializeSubscript(),this._initializePrefixAndSuffix()}ngAfterContentChecked(){this._assertFormFieldControl(),this._control!==this._previousControl&&(this._initializeControl(this._previousControl),this._control.ngControl&&this._control.ngControl.control&&(this._previousControlValidatorFn=this._control.ngControl.control.validator),this._previousControl=this._control),this._control.ngControl&&this._control.ngControl.control&&this._control.ngControl.control.validator!==this._previousControlValidatorFn&&this._changeDetectorRef.markForCheck()}ngOnDestroy(){this._outlineLabelOffsetResizeObserver?.disconnect(),this._stateChanges?.unsubscribe(),this._valueChanges?.unsubscribe(),this._describedByChanges?.unsubscribe(),this._destroyed.next(),this._destroyed.complete()}getLabelId=lt(()=>this._hasFloatingLabel()?this._labelId:null);getConnectedOverlayOrigin(){return this._textField||this._elementRef}_animateAndLockLabel(){this._hasFloatingLabel()&&(this.floatLabel="always")}_initializeControl(e){let t=this._control,i="mat-mdc-form-field-type-";e&&this._elementRef.nativeElement.classList.remove(i+e.controlType),t.controlType&&this._elementRef.nativeElement.classList.add(i+t.controlType),this._stateChanges?.unsubscribe(),this._stateChanges=t.stateChanges.subscribe(()=>{this._updateFocusState(),this._changeDetectorRef.markForCheck()}),this._describedByChanges?.unsubscribe(),this._describedByChanges=t.stateChanges.pipe(we([void 0,void 0]),yt(()=>[t.errorState,t.userAriaDescribedBy]),bn(),ee(([[a,r],[l,h]])=>a!==l||r!==h)).subscribe(()=>this._syncDescribedByIds()),this._valueChanges?.unsubscribe(),t.ngControl&&t.ngControl.valueChanges&&(this._valueChanges=t.ngControl.valueChanges.pipe(j(this._destroyed)).subscribe(()=>this._changeDetectorRef.markForCheck()))}_checkPrefixAndSuffixTypes(){this._hasIconPrefix=!!this._prefixChildren.find(e=>!e._isText),this._hasTextPrefix=!!this._prefixChildren.find(e=>e._isText),this._hasIconSuffix=!!this._suffixChildren.find(e=>!e._isText),this._hasTextSuffix=!!this._suffixChildren.find(e=>e._isText)}_initializePrefixAndSuffix(){this._checkPrefixAndSuffixTypes(),Ae(this._prefixChildren.changes,this._suffixChildren.changes).subscribe(()=>{this._checkPrefixAndSuffixTypes(),this._changeDetectorRef.markForCheck()})}_initializeSubscript(){this._hintChildren.changes.subscribe(()=>{this._processHints(),this._changeDetectorRef.markForCheck()}),this._errorChildren.changes.subscribe(()=>{this._syncDescribedByIds(),this._changeDetectorRef.markForCheck()}),this._validateHints(),this._syncDescribedByIds()}_assertFormFieldControl(){this._control}_updateFocusState(){let e=this._control.focused;e&&!this._isFocused?(this._isFocused=!0,this._lineRipple?.activate()):!e&&(this._isFocused||this._isFocused===null)&&(this._isFocused=!1,this._lineRipple?.deactivate()),this._elementRef.nativeElement.classList.toggle("mat-focused",e),this._textField?.nativeElement.classList.toggle("mdc-text-field--focused",e)}_syncOutlineLabelOffset(){In({earlyRead:()=>{if(this._appearanceSignal()!=="outline")return this._outlineLabelOffsetResizeObserver?.disconnect(),null;if(globalThis.ResizeObserver){this._outlineLabelOffsetResizeObserver||=new globalThis.ResizeObserver(()=>{this._writeOutlinedLabelStyles(this._getOutlinedLabelOffset())});for(let e of this._prefixSuffixContainers())this._outlineLabelOffsetResizeObserver.observe(e,{box:"border-box"})}return this._getOutlinedLabelOffset()},write:e=>this._writeOutlinedLabelStyles(e())})}_shouldAlwaysFloat(){return this.floatLabel==="always"}_hasOutline(){return this.appearance==="outline"}_forceDisplayInfixLabel(){return!this._platform.isBrowser&&this._prefixChildren.length&&!this._shouldLabelFloat()}_hasFloatingLabel=lt(()=>!!this._labelChild());_shouldLabelFloat(){return this._hasFloatingLabel()?this._control.shouldLabelFloat||this._shouldAlwaysFloat():!1}_shouldForward(e){let t=this._control?this._control.ngControl:null;return t&&t[e]}_getSubscriptMessageType(){return this._errorChildren&&this._errorChildren.length>0&&this._control.errorState?"error":"hint"}_handleLabelResized(){this._refreshOutlineNotchWidth()}_refreshOutlineNotchWidth(){!this._hasOutline()||!this._floatingLabel||!this._shouldLabelFloat()?this._notchedOutline?._setNotchWidth(0):this._notchedOutline?._setNotchWidth(this._floatingLabel.getWidth())}_processHints(){this._validateHints(),this._syncDescribedByIds()}_validateHints(){this._hintChildren}_syncDescribedByIds(){if(this._control){let e=[];if(this._control.userAriaDescribedBy&&typeof this._control.userAriaDescribedBy=="string"&&e.push(...this._control.userAriaDescribedBy.split(" ")),this._getSubscriptMessageType()==="hint"){let a=this._hintChildren?this._hintChildren.find(l=>l.align==="start"):null,r=this._hintChildren?this._hintChildren.find(l=>l.align==="end"):null;a?e.push(a.id):this._hintLabel&&e.push(this._hintLabelId),r&&e.push(r.id)}else this._errorChildren&&e.push(...this._errorChildren.map(a=>a.id));let t=this._control.describedByIds,i;if(t){let a=this._describedByIds||e;i=e.concat(t.filter(r=>r&&!a.includes(r)))}else i=e;this._control.setDescribedByIds(i),this._describedByIds=e}}_getOutlinedLabelOffset(){if(!this._hasOutline()||!this._floatingLabel)return null;if(!this._iconPrefixContainer&&!this._textPrefixContainer)return["",null];if(!this._isAttachedToDom())return null;let e=this._iconPrefixContainer?.nativeElement,t=this._textPrefixContainer?.nativeElement,i=this._iconSuffixContainer?.nativeElement,a=this._textSuffixContainer?.nativeElement,r=e?.getBoundingClientRect().width??0,l=t?.getBoundingClientRect().width??0,h=i?.getBoundingClientRect().width??0,u=a?.getBoundingClientRect().width??0,p=this._currentDirection==="rtl"?"-1":"1",k=`${r+l}px`,J=`calc(${p} * (${k} + var(--mat-mdc-form-field-label-offset-x, 0px)))`,$=`var(--mat-mdc-form-field-label-transform, ${Wr} translateX(${J}))`,re=r+l+h+u;return[$,re]}_writeOutlinedLabelStyles(e){if(e!==null){let[t,i]=e;this._floatingLabel&&(this._floatingLabel.element.style.transform=t),i!==null&&this._notchedOutline?._setMaxWidth(i)}}_isAttachedToDom(){let e=this._elementRef.nativeElement;if(e.getRootNode){let t=e.getRootNode();return t&&t!==e}return document.documentElement.contains(e)}static \u0275fac=function(t){return new(t||n)};static \u0275cmp=C({type:n,selectors:[["mat-form-field"]],contentQueries:function(t,i,a){if(t&1&&(Pn(a,i._labelChild,et,5),jt(a,It,5)(a,la,5)(a,da,5)(a,sa,5)(a,nn,5)),t&2){Ai();let r;w(r=M())&&(i._formFieldControl=r.first),w(r=M())&&(i._prefixChildren=r),w(r=M())&&(i._suffixChildren=r),w(r=M())&&(i._errorChildren=r),w(r=M())&&(i._hintChildren=r)}},viewQuery:function(t,i){if(t&1&&(Tn(i._iconPrefixContainerSignal,Qo,5)(i._textPrefixContainerSignal,Ko,5)(i._iconSuffixContainerSignal,Jo,5)(i._textSuffixContainerSignal,ea,5),K(xr,5)(Qo,5)(Ko,5)(Jo,5)(ea,5)(ta,5)(oa,5)(na,5)),t&2){Ai(4);let a;w(a=M())&&(i._textField=a.first),w(a=M())&&(i._iconPrefixContainer=a.first),w(a=M())&&(i._textPrefixContainer=a.first),w(a=M())&&(i._iconSuffixContainer=a.first),w(a=M())&&(i._textSuffixContainer=a.first),w(a=M())&&(i._floatingLabel=a.first),w(a=M())&&(i._notchedOutline=a.first),w(a=M())&&(i._lineRipple=a.first)}},hostAttrs:[1,"mat-mdc-form-field"],hostVars:38,hostBindings:function(t,i){t&2&&P("mat-mdc-form-field-label-always-float",i._shouldAlwaysFloat())("mat-mdc-form-field-has-icon-prefix",i._hasIconPrefix)("mat-mdc-form-field-has-icon-suffix",i._hasIconSuffix)("mat-form-field-invalid",i._control.errorState)("mat-form-field-disabled",i._control.disabled)("mat-form-field-autofilled",i._control.autofilled)("mat-form-field-appearance-fill",i.appearance=="fill")("mat-form-field-appearance-outline",i.appearance=="outline")("mat-form-field-hide-placeholder",i._hasFloatingLabel()&&!i._shouldLabelFloat())("mat-primary",i.color!=="accent"&&i.color!=="warn")("mat-accent",i.color==="accent")("mat-warn",i.color==="warn")("ng-untouched",i._shouldForward("untouched"))("ng-touched",i._shouldForward("touched"))("ng-pristine",i._shouldForward("pristine"))("ng-dirty",i._shouldForward("dirty"))("ng-valid",i._shouldForward("valid"))("ng-invalid",i._shouldForward("invalid"))("ng-pending",i._shouldForward("pending"))},inputs:{hideRequiredMarker:"hideRequiredMarker",color:"color",floatLabel:"floatLabel",appearance:"appearance",subscriptSizing:"subscriptSizing",hintLabel:"hintLabel"},exportAs:["matFormField"],features:[de([{provide:Ft,useExisting:n},{provide:ca,useExisting:n}])],ngContentSelectors:wr,decls:18,vars:21,consts:[["labelTemplate",""],["textField",""],["iconPrefixContainer",""],["textPrefixContainer",""],["textSuffixContainer",""],["iconSuffixContainer",""],[1,"mat-mdc-text-field-wrapper","mdc-text-field",3,"click"],[1,"mat-mdc-form-field-focus-overlay"],[1,"mat-mdc-form-field-flex"],["matFormFieldNotchedOutline","",3,"matFormFieldNotchedOutlineOpen"],[1,"mat-mdc-form-field-icon-prefix"],[1,"mat-mdc-form-field-text-prefix"],[1,"mat-mdc-form-field-infix"],[3,"ngTemplateOutlet"],[1,"mat-mdc-form-field-text-suffix"],[1,"mat-mdc-form-field-icon-suffix"],["matFormFieldLineRipple",""],["aria-atomic","true","aria-live","polite",1,"mat-mdc-form-field-subscript-wrapper","mat-mdc-form-field-bottom-align"],[1,"mat-mdc-form-field-error-wrapper"],[1,"mat-mdc-form-field-hint-wrapper"],["matFormFieldFloatingLabel","",3,"floating","monitorResize","id"],["aria-hidden","true",1,"mat-mdc-form-field-required-marker","mdc-floating-label--required"],[3,"id"],[1,"mat-mdc-form-field-hint-spacer"]],template:function(t,i){if(t&1&&(Me(Cr),te(0,Sr,1,1,"ng-template",null,0,Ut),d(2,"div",6,1),y("click",function(r){return i._control.onContainerClick(r)}),v(4,Dr,1,0,"div",7),d(5,"div",8),v(6,Pr,2,2,"div",9),v(7,Tr,3,0,"div",10),v(8,Rr,3,0,"div",11),d(9,"div",12),v(10,Ir,1,1,null,13),W(11),c(),v(12,Fr,3,0,"div",14),v(13,Lr,3,0,"div",15),c(),v(14,Br,1,0,"div",16),c(),d(15,"div",17),v(16,Nr,2,0,"div",18)(17,zr,5,1,"div",19),c()),t&2){let a;m(2),P("mdc-text-field--filled",!i._hasOutline())("mdc-text-field--outlined",i._hasOutline())("mdc-text-field--no-label",!i._hasFloatingLabel())("mdc-text-field--disabled",i._control.disabled)("mdc-text-field--invalid",i._control.errorState),m(2),b(!i._hasOutline()&&!i._control.disabled?4:-1),m(2),b(i._hasOutline()?6:-1),m(),b(i._hasIconPrefix?7:-1),m(),b(i._hasTextPrefix?8:-1),m(2),b(!i._hasOutline()||i._forceDisplayInfixLabel()?10:-1),m(2),b(i._hasTextSuffix?12:-1),m(),b(i._hasIconSuffix?13:-1),m(),b(i._hasOutline()?-1:14),m(),P("mat-mdc-form-field-subscript-dynamic-size",i.subscriptSizing==="dynamic");let r=i._getSubscriptMessageType();m(),b((a=r)==="error"?16:a==="hint"?17:-1)}},dependencies:[ta,oa,Wt,na,nn],styles:[`.mdc-text-field {
  display: inline-flex;
...
`],encapsulation:2,changeDetection:0})}return n})();var Te=(()=>{class n{static \u0275fac=function(t){return new(t||n)};static \u0275mod=A({type:n});static \u0275inj=R({imports:[jn,gt,U]})}return n})();var Yr=(()=>{class n{static \u0275fac=function(t){return new(t||n)};static \u0275cmp=C({type:n,selectors:[["ng-component"]],hostAttrs:["cdk-text-field-style-loader",""],decls:0,vars:0,template:function(t,i){},styles:[`textarea.cdk-textarea-autosize {
  resize: none;
}
...
`],encapsulation:2,changeDetection:0})}return n})();var xa=(()=>{class n{static \u0275fac=function(t){return new(t||n)};static \u0275mod=A({type:n});static \u0275inj=R({imports:[pe,cn,U,kt,Te,cn]})}return n})();function bs(n){let o=n.replace(/\D/g,"");if(o.length!==11||/^(\d)\1{10}$/.test(o))return!1;let e=o.split("").map(Number),t=(r,l)=>{let u=r.reduce((p,k,X)=>p+k*(l-X),0)*10%11;return u===10?0:u};return t(e.slice(0,9),10)!==e[9]?!1:t(e.slice(0,10),11)===e[10]}function Ca(n){return n.replace(/\D/g,"").slice(0,11).replace(/(\d{3})(\d)/,"$1.$2").replace(/(\d{3})(\d)/,"$1.$2").replace(/(\d{3})(\d{1,2})$/,"$1-$2")}function wa(){return n=>{let o=n.value;return o?bs(o)?null:{cpfInvalido:!0}:null}}function ys(n){let o=n.replace(/\D/g,"");return o.length>=10&&o.length<=11}function Ma(n){let o=n.replace(/\D/g,"").slice(0,11);return o.length<=10?o.replace(/(\d{2})(\d)/,"($1) $2").replace(/(\d{4})(\d)/,"$1-$2"):o.replace(/(\d{2})(\d)/,"($1) $2").replace(/(\d{5})(\d)/,"$1-$2")}function ka(){return n=>{let o=n.value;return o?ys(o)?null:{telefoneInvalido:!0}:null}}function xs(n){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(n)}function Sa(){return n=>{let o=n.value;return o?xs(o)?null:{emailInvalido:!0}:null}}function Cs(n,o){n&1&&(d(0,"mat-error"),f(1,"E-mail \xE9 obrigat\xF3rio"),c())}function ws(n,o){n&1&&(d(0,"mat-error"),f(1,"E-mail inv\xE1lido"),c())}function Ms(n,o){n&1&&(d(0,"mat-error"),f(1,"Nome \xE9 obrigat\xF3rio"),c())}function ks(n,o){n&1&&(d(0,"mat-error"),f(1,"CPF \xE9 obrigat\xF3rio"),c())}function Ss(n,o){n&1&&(d(0,"mat-error"),f(1,"CPF inv\xE1lido"),c())}function Ds(n,o){n&1&&(d(0,"mat-error"),f(1,"Telefone \xE9 obrigat\xF3rio"),c())}function Os(n,o){n&1&&(d(0,"mat-error"),f(1,"Telefone inv\xE1lido"),c())}var ki=class n{fb=s(ro);dialogRef=s(Je);data=s(Tt);form=this.fb.nonNullable.group({email:["",[Se.required,Sa()]],nome:["",[Se.required]],cpf:["",[Se.required,wa()]],telefone:["",[Se.required,ka()]],tipoTelefone:["CELULAR"]});constructor(){this.data.user&&this.form.patchValue({email:this.data.user.email,nome:this.data.user.nome,cpf:this.data.user.cpf,telefone:this.data.user.telefone,tipoTelefone:this.data.user.tipoTelefone})}onCpfInput(o){let e=o.target,t=Ca(e.value);this.form.controls.cpf.setValue(t)}onPhoneInput(o){let e=o.target,t=Ma(e.value);this.form.controls.telefone.setValue(t)}onSave(){if(this.form.invalid)return;let o=this.form.getRawValue(),e={email:o.email.trim(),nome:o.nome.trim(),cpf:o.cpf,telefone:o.telefone,tipoTelefone:o.tipoTelefone};this.dialogRef.close({action:this.data.user?"update":"create",data:this.data.user?Re(O({},e),{id:this.data.user.id}):e})}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=C({type:n,selectors:[["app-user-modal"]],decls:45,vars:10,consts:[["mat-dialog-title",""],["id","user-form",1,"user-form",3,"formGroup"],["appearance","outline",1,"full-width"],["matInput","","formControlName","email","placeholder","usuario@email.com","id","user-email-input"],["matInput","","formControlName","nome","placeholder","Nome completo","id","user-nome-input"],[1,"form-row"],["appearance","outline"],["matInput","","formControlName","cpf","placeholder","000.000.000-00","maxlength","14","id","user-cpf-input",3,"input"],["matInput","","formControlName","telefone","placeholder","(00) 00000-0000","maxlength","15","id","user-telefone-input",3,"input"],["formControlName","tipoTelefone","id","user-tipo-telefone-select"],["value","CELULAR"],["value","RESIDENCIAL"],["value","COMERCIAL"],[1,"form-hint"],["align","end"],["mat-button","","mat-dialog-close","","id","user-cancel-btn"],["mat-flat-button","","color","primary","id","user-save-btn",3,"click","disabled"]],template:function(e,t){e&1&&(d(0,"h2",0),f(1),c(),d(2,"mat-dialog-content")(3,"form",1)(4,"mat-form-field",2)(5,"mat-label"),f(6,"Usu\xE1rio (e-mail)"),c(),N(7,"input",3),v(8,Cs,2,0,"mat-error"),v(9,ws,2,0,"mat-error"),c(),d(10,"mat-form-field",2)(11,"mat-label"),f(12,"Nome completo"),c(),N(13,"input",4),v(14,Ms,2,0,"mat-error"),c(),d(15,"div",5)(16,"mat-form-field",6)(17,"mat-label"),f(18,"CPF"),c(),d(19,"input",7),y("input",function(a){return t.onCpfInput(a)}),c(),v(20,ks,2,0,"mat-error"),v(21,Ss,2,0,"mat-error"),c(),d(22,"mat-form-field",6)(23,"mat-label"),f(24,"Telefone"),c(),d(25,"input",8),y("input",function(a){return t.onPhoneInput(a)}),c(),v(26,Ds,2,0,"mat-error"),v(27,Os,2,0,"mat-error"),c(),d(28,"mat-form-field",6)(29,"mat-label"),f(30,"Tipo"),c(),d(31,"mat-select",9)(32,"mat-option",10),f(33,"Celular"),c(),d(34,"mat-option",11),f(35,"Residencial"),c(),d(36,"mat-option",12),f(37,"Comercial"),c()()()(),d(38,"p",13),f(39," O usu\xE1rio receber\xE1 uma senha provis\xF3ria para acesso ao sistema por SMS. "),c()()(),d(40,"mat-dialog-actions",14)(41,"button",15),f(42,"CANCELAR"),c(),d(43,"button",16),y("click",function(){return t.onSave()}),f(44," SALVAR "),c()()),e&2&&(m(),oe(" ",t.data.user?"Editar usu\xE1rio":"Adicionar novo usu\xE1rio"," "),m(2),E("formGroup",t.form),m(5),b(t.form.controls.email.hasError("required")&&t.form.controls.email.touched?8:-1),m(),b(t.form.controls.email.hasError("emailInvalido")&&t.form.controls.email.touched?9:-1),m(5),b(t.form.controls.nome.hasError("required")&&t.form.controls.nome.touched?14:-1),m(6),b(t.form.controls.cpf.hasError("required")&&t.form.controls.cpf.touched?20:-1),m(),b(t.form.controls.cpf.hasError("cpfInvalido")&&t.form.controls.cpf.touched?21:-1),m(5),b(t.form.controls.telefone.hasError("required")&&t.form.controls.telefone.touched?26:-1),m(),b(t.form.controls.telefone.hasError("telefoneInvalido")&&t.form.controls.telefone.touched?27:-1),m(16),E("disabled",t.form.invalid))},dependencies:[lo,no,Zt,Kt,to,ao,mt,oo,ui,mi,hi,pi,fi,Te,gt,et,on,xi,yi,xa,ya,bt,xe,Ne,ye],styles:[".user-form[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:12px;min-width:400px;padding-top:8px}@media(max-width:640px){.user-form[_ngcontent-%COMP%]{min-width:unset}}.user-form[_ngcontent-%COMP%]   mat-form-field[_ngcontent-%COMP%]{transition:all .2s ease}.user-form[_ngcontent-%COMP%]   mat-form-field[_ngcontent-%COMP%]:focus-within{opacity:1}.full-width[_ngcontent-%COMP%]{width:100%}.form-row[_ngcontent-%COMP%]{display:grid;grid-template-columns:1fr 1fr 120px;gap:16px;margin-top:8px}@media(max-width:640px){.form-row[_ngcontent-%COMP%]{grid-template-columns:1fr;gap:12px}}@media(min-width:600px)and (max-width:900px){.form-row[_ngcontent-%COMP%]{grid-template-columns:1fr 1fr}.form-row[_ngcontent-%COMP%] > [_ngcontent-%COMP%]:last-child{grid-column:1/-1}}.form-hint[_ngcontent-%COMP%]{font:var(--mat-sys-body-small);color:var(--mat-sys-on-surface-variant);margin:0;padding:8px 12px;background-color:var(--mat-sys-surface-container-lowest);border-left:3px solid var(--mat-sys-tertiary);border-radius:4px;transition:all .2s ease}.form-hint[_ngcontent-%COMP%]:hover{background-color:var(--mat-sys-surface-container)}"],changeDetection:0})};var Da=[{id:"1",nome:"Giana Sandrini",email:"giana@attornatus.com.br",cpf:"529.982.247-25",telefone:"(11) 99876-5432",tipoTelefone:"CELULAR"},{id:"2",nome:"Carlos Eduardo Silva",email:"carlos.silva@attornatus.com.br",cpf:"987.654.321-00",telefone:"(21) 98765-4321",tipoTelefone:"CELULAR"},{id:"3",nome:"Ana Paula Ferreira",email:"ana.ferreira@attornatus.com.br",cpf:"123.456.789-09",telefone:"(31) 3456-7890",tipoTelefone:"RESIDENCIAL"},{id:"4",nome:"Roberto Almeida",email:"roberto@attornatus.com.br",cpf:"456.789.123-45",telefone:"(41) 3567-8901",tipoTelefone:"COMERCIAL"},{id:"5",nome:"Mariana Costa",email:"mariana.costa@attornatus.com.br",cpf:"321.654.987-12",telefone:"(51) 99654-3210",tipoTelefone:"CELULAR"},{id:"6",nome:"Felipe Oliveira",email:"felipe.oliveira@attornatus.com.br",cpf:"654.321.987-34",telefone:"(61) 98543-2109",tipoTelefone:"CELULAR"},{id:"7",nome:"Juliana Santos",email:"juliana.santos@attornatus.com.br",cpf:"789.123.456-56",telefone:"(71) 3432-1098",tipoTelefone:"RESIDENCIAL"},{id:"8",nome:"Pedro Henrique Lima",email:"pedro.lima@attornatus.com.br",cpf:"147.258.369-78",telefone:"(81) 97321-0987",tipoTelefone:"CELULAR"},{id:"9",nome:"Beatriz Rodrigues",email:"beatriz@attornatus.com.br",cpf:"258.369.147-90",telefone:"(91) 3210-9876",tipoTelefone:"COMERCIAL"},{id:"10",nome:"Lucas Martins",email:"lucas.martins@attornatus.com.br",cpf:"369.147.258-01",telefone:"(11) 96109-8765",tipoTelefone:"CELULAR"},{id:"11",nome:"Camila Pereira",email:"camila@attornatus.com.br",cpf:"741.852.963-23",telefone:"(21) 3098-7654",tipoTelefone:"RESIDENCIAL"},{id:"12",nome:"Thiago Nascimento",email:"thiago@attornatus.com.br",cpf:"852.963.741-45",telefone:"(31) 95987-6543",tipoTelefone:"CELULAR"}];var Si=class n{users=[...Da];simulateDelay(o,e=600){return _n(e).pipe(_e(()=>ue(o)))}getAll(){return this.simulateDelay([...this.users])}getById(o){let e=this.users.find(t=>t.id===o);return this.simulateDelay(e,300)}search(o){let e=o.toLowerCase(),t=this.users.filter(i=>i.nome.toLowerCase().includes(e)||i.email.toLowerCase().includes(e));return this.simulateDelay(t,400)}create(o){let e=Re(O({},o),{id:crypto.randomUUID()});return this.users=[...this.users,e],this.simulateDelay(e,500)}update(o){let e=this.users.findIndex(i=>i.id===o.id);if(e===-1)return un(()=>new Error("Usu\xE1rio n\xE3o encontrado."));let t=O(O({},this.users[e]),o);return this.users=this.users.map(i=>i.id===o.id?t:i),this.simulateDelay(t,500)}delete(o){return this.users=this.users.filter(e=>e.id!==o),this.simulateDelay(void 0,300)}static \u0275fac=function(e){return new(e||n)};static \u0275prov=I({token:n,factory:n.\u0275fac,providedIn:"root"})};function Oa(n,o,e){let t=n.filter(o),i=t.length,a=Math.max(1,Math.ceil(i/e.tamanho)),r=Math.min(Math.max(1,e.pagina),a),l=(r-1)*e.tamanho,h=t.slice(l,l+e.tamanho);return Object.freeze({itens:h,totalRegistros:i,paginaAtual:r,totalPaginas:a})}var Lt=class n{api=s(Si);destroyRef=s(Mn);_users=Q([]);_loading=Q(!1);_error=Q(null);_searchTerm=Q("");_currentPage=Q(1);_pageSize=Q(5);users=this._users.asReadonly();loading=this._loading.asReadonly();error=this._error.asReadonly();searchTerm=this._searchTerm.asReadonly();currentPage=this._currentPage.asReadonly();page=lt(()=>Oa(this._users(),()=>!0,{pagina:this._currentPage(),tamanho:this._pageSize()}));searchSubject=new _;constructor(){this.setupSearch()}setupSearch(){this.searchSubject.pipe(gn(300),vn(),Cn(()=>{this._loading.set(!0),this._error.set(null)}),_e(o=>(o?this.api.search(o):this.api.getAll()).pipe(it(t=>(this._error.set(t.message||"Erro ao buscar usu\xE1rios."),ue([]))),nt(()=>this._loading.set(!1)))),ht(this.destroyRef)).subscribe(o=>{this._users.set(o),this._currentPage.set(1)})}loadUsers(){this._loading.set(!0),this._error.set(null),this.api.getAll().pipe(it(o=>(this._error.set(o.message||"Falha ao carregar usu\xE1rios."),ue([]))),nt(()=>this._loading.set(!1)),ht(this.destroyRef)).subscribe(o=>this._users.set(o))}setSearchTerm(o){this._searchTerm.set(o),this.searchSubject.next(o)}setCurrentPage(o){this._currentPage.set(o)}createUser(o){this._loading.set(!0),this.api.create(o).pipe(_e(()=>this.api.getAll()),it(e=>(this._error.set(e.message||"Erro ao criar usu\xE1rio."),ue([]))),nt(()=>this._loading.set(!1)),ht(this.destroyRef)).subscribe(e=>this._users.set(e))}updateUser(o){this._loading.set(!0),this.api.update(o).pipe(_e(()=>this.api.getAll()),it(e=>(this._error.set(e.message||"Erro ao atualizar usu\xE1rio."),ue([]))),nt(()=>this._loading.set(!1)),ht(this.destroyRef)).subscribe(e=>this._users.set(e))}deleteUser(o){this._loading.set(!0),this.api.delete(o).pipe(_e(()=>this.api.getAll()),it(e=>(this._error.set(e.message||"Erro ao excluir usu\xE1rio."),ue([]))),nt(()=>this._loading.set(!1)),ht(this.destroyRef)).subscribe(e=>this._users.set(e))}static \u0275fac=function(e){return new(e||n)};static \u0275prov=I({token:n,factory:n.\u0275fac})};var Di=class n{data=s(Tt);static \u0275fac=function(e){return new(e||n)};static \u0275cmp=C({type:n,selectors:[["app-confirm-dialog"]],decls:14,vars:5,consts:[[1,"confirm-dialog"],[1,"confirm-dialog__icon"],["mat-dialog-title","",1,"confirm-dialog__title"],[1,"confirm-dialog__message"],["align","end",1,"confirm-dialog__actions"],["mat-button","","mat-dialog-close","","id","confirm-cancel-btn"],["mat-flat-button","","id","confirm-delete-btn",1,"confirm-dialog__delete-btn",3,"mat-dialog-close"]],template:function(e,t){e&1&&(d(0,"div",0)(1,"div",1)(2,"mat-icon"),f(3,"warning_amber"),c()(),d(4,"h2",2),f(5),c(),d(6,"mat-dialog-content")(7,"p",3),f(8),c()(),d(9,"mat-dialog-actions",4)(10,"button",5),f(11),c(),d(12,"button",6),f(13),c()()()),e&2&&(m(5),G(t.data.title),m(3),G(t.data.message),m(3),oe(" ",t.data.cancelText||"CANCELAR"," "),m(),E("mat-dialog-close",!0),m(),oe(" ",t.data.confirmText||"EXCLUIR"," "))},dependencies:[ui,mi,hi,pi,fi,xe,Ne,ye,Be],styles:[".confirm-dialog[_ngcontent-%COMP%]{text-align:center;padding:8px 0 0}.confirm-dialog__icon[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:center;margin:0 auto 12px;width:56px;height:56px;border-radius:50%;background-color:var(--mat-sys-error-container);color:var(--mat-sys-error)}.confirm-dialog__icon[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%]{font-size:32px;width:32px;height:32px}.confirm-dialog__title[_ngcontent-%COMP%]{font:var(--mat-sys-title-large);color:var(--mat-sys-on-surface);margin:0 0 8px}.confirm-dialog__message[_ngcontent-%COMP%]{font:var(--mat-sys-body-medium);color:var(--mat-sys-on-surface-variant);margin:0}.confirm-dialog__actions[_ngcontent-%COMP%]{padding-top:16px}.confirm-dialog__delete-btn[_ngcontent-%COMP%]{background-color:#f44336!important;color:#fff!important}"],changeDetection:0})};var Es=(n,o)=>o.id;function Ps(n,o){if(n&1){let e=ve();d(0,"button",9),y("click",function(){se(e);let i=x();return le(i.shell.toggleSidenav())}),d(1,"mat-icon"),f(2,"menu"),c()()}}function Ts(n,o){if(n&1){let e=ve();d(0,"div",6)(1,"mat-icon"),f(2,"warning"),c(),d(3,"span"),f(4),c(),d(5,"button",10),y("click",function(){se(e);let i=x();return le(i.store.loadUsers())}),f(6,"Tentar novamente"),c()()}n&2&&(m(4),G(o))}function Rs(n,o){n&1&&(d(0,"div",7),N(1,"mat-spinner",11),d(2,"p"),f(3,"Carregando usu\xE1rios..."),c()())}function As(n,o){n&1&&(d(0,"div",12)(1,"mat-icon"),f(2,"person_off"),c(),d(3,"p"),f(4,"Nenhum usu\xE1rio encontrado."),c()())}function Is(n,o){if(n&1){let e=ve();d(0,"app-user-card",16),y("editClicked",function(i){se(e);let a=x(3);return le(a.openModal(i))})("deleteClicked",function(i){se(e);let a=x(3);return le(a.onDelete(i))}),c()}if(n&2){let e=o.$implicit;E("user",e)}}function Fs(n,o){if(n&1){let e=ve();d(0,"button",21),y("click",function(){let i=se(e).$implicit,a=x(4);return le(a.store.setCurrentPage(i))}),f(1),c()}if(n&2){let e=o.$implicit,t=x(4);P("pagination__btn--inactive",e!==t.store.page().paginaAtual),E("color",e===t.store.page().paginaAtual?"primary":void 0),m(),oe(" ",e," ")}}function Ls(n,o){if(n&1){let e=ve();d(0,"div",15)(1,"button",17),y("click",function(){se(e);let i=x(3);return le(i.store.setCurrentPage(i.store.page().paginaAtual-1))}),d(2,"mat-icon"),f(3,"chevron_left"),c()(),Pi(4,Fs,2,4,"button",18,On),d(6,"button",19),y("click",function(){se(e);let i=x(3);return le(i.store.setCurrentPage(i.store.page().paginaAtual+1))}),d(7,"mat-icon"),f(8,"chevron_right"),c()(),d(9,"span",20),f(10),c()()}if(n&2){let e=x(3);m(),E("disabled",e.store.page().paginaAtual<=1),m(3),Ti(e.getPages()),m(2),E("disabled",e.store.page().paginaAtual>=e.store.page().totalPaginas),m(4),oe(" ",e.store.page().totalRegistros," registros ")}}function Bs(n,o){if(n&1&&(d(0,"div",13),Pi(1,Is,1,1,"app-user-card",14,Es),c(),v(3,Ls,11,3,"div",15)),n&2){let e=x(2);m(),Ti(e.store.page().itens),m(2),b(e.store.page().totalPaginas>1?3:-1)}}function Ns(n,o){if(n&1&&v(0,As,5,0,"div",12)(1,Bs,4,1),n&2){let e=x();b(e.store.page().itens.length===0&&!e.store.loading()?0:1)}}var Ea=class n{store=s(Lt);dialog=s(Rt);snackBar=s(Qi);shell=s(ho,{optional:!0});ngOnInit(){this.store.loadUsers()}getPages(){return Array.from({length:this.store.page().totalPaginas},(o,e)=>e+1)}openModal(o){this.dialog.open(ki,{data:{user:o},width:"600px",maxWidth:"95vw"}).afterClosed().subscribe(t=>{t&&(t.action==="create"?(this.store.createUser(t.data),this.snackBar.open("Usu\xE1rio cadastrado com sucesso!","OK",{duration:3e3})):t.action==="update"&&(this.store.updateUser(t.data),this.snackBar.open("Usu\xE1rio atualizado com sucesso!","OK",{duration:3e3})))})}onDelete(o){let e=this.store.page().itens.find(i=>i.id===o);if(!e)return;this.dialog.open(Di,{data:{title:"Excluir usu\xE1rio",message:`Tem certeza que deseja excluir o usu\xE1rio "${e.nome}"? Esta a\xE7\xE3o n\xE3o pode ser desfeita.`,confirmText:"EXCLUIR",cancelText:"CANCELAR"},width:"400px",maxWidth:"90vw"}).afterClosed().subscribe(i=>{i&&(this.store.deleteUser(o),this.snackBar.open("Usu\xE1rio exclu\xEDdo com sucesso!","OK",{duration:3e3}))})}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=C({type:n,selectors:[["app-user-list"]],features:[de([Lt])],decls:14,vars:6,consts:[[1,"header"],["mat-icon-button","","aria-label","Abrir menu","id","toggle-sidenav-btn",1,"header__menu-btn"],[1,"header__title"],[3,"valueChange","value","loading"],[1,"content"],[1,"content__subtitle"],[1,"error-banner"],[1,"loading-container"],["mat-fab","","color","warn","aria-label","Adicionar usu\xE1rio","id","add-user-fab",1,"fab",3,"click"],["mat-icon-button","","aria-label","Abrir menu","id","toggle-sidenav-btn",1,"header__menu-btn",3,"click"],["mat-button","","color","warn",3,"click"],["diameter","40"],[1,"empty-state"],[1,"user-list"],[3,"user"],[1,"pagination"],[3,"editClicked","deleteClicked","user"],["mat-icon-button","","aria-label","P\xE1gina anterior",3,"click","disabled"],["mat-mini-fab","",3,"color","pagination__btn--inactive"],["mat-icon-button","","aria-label","Pr\xF3xima p\xE1gina",3,"click","disabled"],[1,"pagination__info"],["mat-mini-fab","",3,"click","color"]],template:function(e,t){if(e&1&&(d(0,"header",0),v(1,Ps,3,0,"button",1),d(2,"h1",2),f(3,"USU\xC1RIOS"),c(),d(4,"app-user-filter",3),y("valueChange",function(a){return t.store.setSearchTerm(a)}),c()(),d(5,"main",4)(6,"p",5),f(7,"Usu\xE1rios cadastrados"),c(),v(8,Ts,7,1,"div",6),v(9,Rs,4,0,"div",7),v(10,Ns,2,1),c(),d(11,"button",8),y("click",function(){return t.openModal(null)}),d(12,"mat-icon"),f(13,"add"),c()()),e&2){let i;m(),b(t.shell?1:-1),m(3),E("value",t.store.searchTerm())("loading",t.store.loading()&&!!t.store.searchTerm()),m(4),b((i=t.store.error())?8:-1,i),m(),b(t.store.loading()&&!t.store.searchTerm()?9:-1),m(),b(!t.store.loading()||t.store.searchTerm()?10:-1)}},dependencies:[ye,Be,xe,Ne,Jn,$t,Kn,zo,Vo,Uo,_i,Ci],styles:["[_nghost-%COMP%]{display:flex;flex-direction:column;height:100%;background-color:var(--mat-sys-surface-container-lowest)}.header[_ngcontent-%COMP%]{background-color:var(--mat-sys-surface);box-shadow:0 2px 4px #0000001a;padding:12px 24px;display:flex;align-items:center;justify-content:space-between;gap:16px;transition:box-shadow .2s ease}@media(max-width:640px){.header[_ngcontent-%COMP%]{padding:12px 8px 12px 4px;gap:8px}}.header__menu-btn[_ngcontent-%COMP%]{flex-shrink:0;transition:color .2s ease}.header__menu-btn[_ngcontent-%COMP%]:hover{color:var(--mat-sys-primary)}@media(min-width:960px){.header__menu-btn[_ngcontent-%COMP%]{display:none}}.header__title[_ngcontent-%COMP%]{font:var(--mat-sys-title-medium);color:var(--mat-sys-on-surface);margin:0;white-space:nowrap;flex-shrink:0;font-weight:500;letter-spacing:.5px}.content[_ngcontent-%COMP%]{flex:1;padding:24px;max-width:900px;margin:0 auto;width:100%;box-sizing:border-box;overflow-y:auto;transition:padding .2s ease}@media(max-width:640px){.content[_ngcontent-%COMP%]{padding:16px;max-width:100%}}@media(min-width:600px){.content[_ngcontent-%COMP%]{padding:20px 24px}}@media(min-width:1200px){.content[_ngcontent-%COMP%]{padding:24px}}.content__subtitle[_ngcontent-%COMP%]{font:var(--mat-sys-body-small);color:var(--mat-sys-on-surface-variant);margin:0 0 16px}.error-banner[_ngcontent-%COMP%]{display:flex;align-items:center;gap:12px;padding:12px 16px;background-color:var(--mat-sys-error-container);color:var(--mat-sys-on-error-container);border-radius:8px;border-left:4px solid var(--mat-sys-error);margin-bottom:16px;box-shadow:0 2px 4px #0000001a;animation:_ngcontent-%COMP%_fadeInTop .3s ease-out}.error-banner[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%]{flex-shrink:0;font-size:24px;width:24px;height:24px}.error-banner[_ngcontent-%COMP%]   span[_ngcontent-%COMP%]{flex:1;font:var(--mat-sys-body-medium)}.error-banner[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]{flex-shrink:0;transition:all .2s ease}.error-banner[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]:hover{opacity:.8}@media(max-width:640px){.error-banner[_ngcontent-%COMP%]{flex-direction:column;align-items:flex-start}.error-banner[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]{align-self:flex-end}}.loading-container[_ngcontent-%COMP%]{display:flex;flex-direction:column;align-items:center;justify-content:center;padding:64px 0;gap:16px;color:var(--mat-sys-on-surface-variant);animation:_ngcontent-%COMP%_fadeIn .3s ease-out}.loading-container[_ngcontent-%COMP%]   p[_ngcontent-%COMP%]{font:var(--mat-sys-body-medium);margin:0;animation:_ngcontent-%COMP%_fadeIn .5s ease-out .1s both}@media(max-width:640px){.loading-container[_ngcontent-%COMP%]{padding:32px 16px}}.empty-state[_ngcontent-%COMP%]{display:flex;flex-direction:column;align-items:center;padding:64px 16px;color:var(--mat-sys-on-surface-variant);animation:_ngcontent-%COMP%_fadeIn .3s ease-out}.empty-state[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%]{font-size:64px;width:64px;height:64px;margin-bottom:12px;opacity:.5}.empty-state[_ngcontent-%COMP%]   p[_ngcontent-%COMP%]{font:var(--mat-sys-body-medium);margin:0}@media(max-width:640px){.empty-state[_ngcontent-%COMP%]{padding:32px 16px}.empty-state[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%]{font-size:48px;width:48px;height:48px}}.user-list[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:8px}.pagination[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:center;gap:4px;padding-top:24px;flex-wrap:wrap;transition:all .2s ease}@media(max-width:640px){.pagination[_ngcontent-%COMP%]{padding-top:20px}}.pagination__btn--inactive[_ngcontent-%COMP%]{background-color:transparent;box-shadow:none;color:var(--mat-sys-on-surface-variant);transition:all .2s ease}.pagination__btn--inactive[_ngcontent-%COMP%]:hover:not(:disabled){background-color:#1976d20d;color:var(--mat-sys-primary)}.pagination__info[_ngcontent-%COMP%]{margin-left:12px;font:var(--mat-sys-body-small);color:var(--mat-sys-on-surface-variant)}@media(max-width:640px){.pagination__info[_ngcontent-%COMP%]{margin-left:0;margin-top:12px;width:100%;text-align:center}}.fab[_ngcontent-%COMP%]{position:fixed;bottom:24px;right:24px;z-index:10;background-color:#f44336!important;color:#fff!important;box-shadow:0 12px 24px #0000002e!important;transition:all .2s ease}.fab[_ngcontent-%COMP%]:hover{box-shadow:0 16px 32px #0003!important;transform:scale(1.08)}.fab[_ngcontent-%COMP%]:active{transform:scale(.95)}@media(max-width:640px){.fab[_ngcontent-%COMP%]{bottom:16px;right:16px}}@media(min-width:600px){.fab[_ngcontent-%COMP%]{bottom:20px;right:20px}}@keyframes _ngcontent-%COMP%_fadeInTop{0%{transform:translateY(-10px);opacity:0}to{transform:translateY(0);opacity:1}}@keyframes _ngcontent-%COMP%_fadeIn{0%{opacity:0}to{opacity:1}}"],changeDetection:0})};export{Ea as UserListComponent};
